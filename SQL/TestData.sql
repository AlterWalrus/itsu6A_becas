INSERT INTO `checktec`.`usuario` (`id_Usuario`, `Nombre`, `Apellido_paterno`, `Apellido_materno`, `Correo`, `Usuario`, `Contrasenia`, `Rol`, `Ultimo_acceso`) VALUES ('1', 'Rubén Ociel', 'Medina', 'Pérez', 'nose', 'ruben', '$2y$10$csuhTUIud2GsQNV1kDmybOKEVzi0hY8Xo6x4OPJ7imsJdjj2KkPF6', 'Admin', '2025-02-04 12:00:00');
INSERT INTO `checktec`.`usuario` (`id_Usuario`, `Nombre`, `Apellido_paterno`, `Apellido_materno`, `Correo`, `Usuario`, `Contrasenia`, `Rol`, `Ultimo_acceso`) VALUES ('2', 'Rubén', 'Zamudio', 'González', 'nose2', 'ruben2', '$10$QnDDNLxHZDJ8LnsJD/s4c.wFJA70QKzadra.LClZqxhrNqc.JX4pu', 'Miembro_CESA', '2025-02-04 12:00:00');
